...
const
  ...
  {$IFDEF VER360} // JB
const
  SDelphiKey = 'Software\Embarcadero\BDS\23.0'; {Delphi 12 Athens}
  {$ENDIF}  
  {$IFDEF VER370} // JB
const
  SDelphiKey = 'Software\Embarcadero\BDS\37.0'; {Delphi 13 Florence}
  {$ENDIF}   
  
  {$IFDEF VER380} // JB
const //for futurum aurum
  SDelphiKey = 'Software\Embarcadero\BDS\38.0'; {Delphi 1x xyz}
  {$ENDIF}  
implementation
